...
REGION_GROUPS = {
    ...
    "경상도": [
        ...
        "창원시", "진주시", "통영시", "사천시", "김해시", "밀양시", "거제시", "양산시", "의령군", "함안군", "창녕군", "경남 고성군", "남해군", "하동군", "산청군", "함양군", "거창군", "합천군",
    ],
    "전라도": [
    ...
    "충청도": [
        "대전 동구", "대전 중구", "대전 서구", "대전 유성구", "대전 대덕구", "세종시",
...
TIME_SLOT_OPTIONS = ["평일 오전", "평일 오후", "평일 저녁", "금요일 저녁", "토요일 오전", "토요일 오후", "일요일 오후"]
BUDGET_OPTIONS = ["무료", "3만원 이내", "5만원 이내", "10만원 이내", "10만원 이상"]
